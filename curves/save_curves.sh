...
cargo run --release moore      11 -t 0 -s 2048 -c 4   -o images/moore.png
cargo run --release moore      11 -t 0 -s 2048 -c bw3 -o images/moore-bw.png
...
cargo run --release triangle   11 -t 0 -s 2048 -c h   -o images/triangle.png
