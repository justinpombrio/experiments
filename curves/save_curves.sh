...
cargo run --release koch        6 -s 2048 -t 0.75 -c b    -o images/koch.png --bg ddd --fill abc --style straight -a 0.25
...
cargo run --release wunderlich  3 -s 2048 -t 0.65  -c m   -o images/wunderlich.png --bg 222 --style straight
cargo run --release arioni      5 -s 2048 -t 0.7   -c o6  -o images/arioni.png --style straight -a -0.078 --bg 222
